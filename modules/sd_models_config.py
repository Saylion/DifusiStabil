...
sd_repo_configs_path = os.path.join(paths.paths['Difusi Stabil'], "configs", "difusi-stabil")
sd_xl_repo_configs_path = os.path.join(paths.paths['Difusi Stabil XL'], "configs", "inference")
